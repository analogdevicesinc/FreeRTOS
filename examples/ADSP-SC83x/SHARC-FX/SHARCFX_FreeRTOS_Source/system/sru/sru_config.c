/*
 **
 ** sru_config.c source file generated on February 21, 2024 at 22:52:06.
 **
...
int32_t adi_SRU_Init(void)
{
    ...
    *pREG_DAI0_EXTD_CLK5 = 0x00000000uL;
    ...
    /* Connections:
     *    DAI0_LOW - SRC8_CLK_OP_I
     *    DAI0_LOW - SRC9_CLK_IP_I
     *    DAI0_LOW - SRC10_CLK_OP_I
     *    DAI0_LOW - SRC8_CLK_IP_I
     *    DAI0_LOW - SRC10_CLK_IP_I
     *    DAI0_LOW - SRC9_CLK_OP_I
     */
    *pREG_DAI0_CLK6 = 0x3def7bdeuL;
    *pREG_DAI0_EXTD_CLK6 = 0x00000000uL;

    /* Connections:
     *    DAI0_LOW - SRC11_CLK_IP_I
     *    DAI0_LOW - SRC11_CLK_OP_I
     */
    *pREG_DAI0_CLK7 = 0x000003deuL;
    *pREG_DAI0_EXTD_CLK7 = 0x00000000uL;
    ...
    *pREG_DAI0_EXTD_DAT6 = 0x00000000uL;
    ...
    /* Connections:
     *    DAI0_PB01_O - SRC11_DAT_IP_I
     *    DAI0_PB01_O - SRC9_DAT_IP_I
     *    DAI0_PB01_O - SRC8_DAT_TDM_OP_I
     *    DAI0_PB01_O - SRC10_DAT_IP_I
     *    DAI0_PB01_O - SRC8_DAT_IP_I
     */
    *pREG_DAI0_DAT7 = 0x00000000uL;
    *pREG_DAI0_EXTD_DAT7 = 0x00000000uL;

    /* Connections:
     *    DAI0_PB01_O - SRC11_DAT_TDM_OP_I
     *    DAI0_PB01_O - SRC9_DAT_TDM_OP_I
     *    DAI0_PB01_O - SRC10_DAT_TDM_OP_I
     */
    *pREG_DAI0_DAT8 = 0x00000000uL;
    *pREG_DAI0_EXTD_DAT8 = 0x00000000uL;
    ...
    *pREG_DAI0_EXTD_FS4 = 0x00000000uL;
    ...
    /* Connections:
     *    DAI0_LOW - SRC8_FS_OP_I
     *    DAI0_LOW - SRC10_FS_IP_I
     *    DAI0_LOW - SRC8_FS_IP_I
     *    DAI0_LOW - SRC9_FS_OP_I
     *    DAI0_LOW - SRC10_FS_OP_I
     *    DAI0_LOW - SRC9_FS_IP_I
     */
    *pREG_DAI0_FS5 = 0x3def7bdeuL;
    *pREG_DAI0_EXTD_FS5 = 0x00000000uL;

    /* Connections:
     *    DAI0_LOW - SRC11_FS_OP_I
     *    DAI0_LOW - SRC11_FS_IP_I
     */
    *pREG_DAI0_FS6 = 0x000003deuL;
    *pREG_DAI0_EXTD_FS6 = 0x00000000uL;
    ...
    *pREG_DAI0_EXTD_PIN4 = 0x00000000uL;
    ...
    /* Connections:
     *    SPT0A_CLK_O - DAI0_DUMMY_PB01_I
     *    SPT3A_CLK_O - DAI0_DUMMY_PB04_I
     *    SPT2A_CLK_O - DAI0_DUMMY_PB03_I
     *    SPT1A_CLK_O - DAI0_DUMMY_PB02_I
     */
    *pREG_DAI0_PIN5 = 0x06891120uL;
    ...
    *pREG_DAI1_EXTD_CLK5 = 0x00000000uL;
    ...
    /* Connections:
     *    DAI1_LOW - SRC14_CLK_IP_I
     *    DAI1_LOW - SRC12_CLK_OP_I
     *    DAI1_LOW - SRC14_CLK_OP_I
     *    DAI1_LOW - SRC12_CLK_IP_I
     *    DAI1_LOW - SRC13_CLK_IP_I
     *    DAI1_LOW - SRC13_CLK_OP_I
     */
    *pREG_DAI1_CLK6 = 0x3def7bdeuL;
    *pREG_DAI1_EXTD_CLK6 = 0x00000000uL;

    /* Connections:
     *    DAI1_LOW - SRC15_CLK_IP_I
     *    DAI1_LOW - SRC15_CLK_OP_I
     */
    *pREG_DAI1_CLK7 = 0x000003deuL;
    *pREG_DAI1_EXTD_CLK7 = 0x00000000uL;
    ...
    *pREG_DAI1_EXTD_DAT6 = 0x00000000uL;
    ...
    /* Connections:
     *    DAI1_PB01_O - SRC13_DAT_IP_I
     *    DAI1_PB01_O - SRC15_DAT_IP_I
     *    DAI1_PB01_O - SRC12_DAT_IP_I
     *    DAI1_PB01_O - SRC12_DAT_TDM_OP_I
     *    DAI1_PB01_O - SRC14_DAT_IP_I
     */
    *pREG_DAI1_DAT7 = 0x00000000uL;
    *pREG_DAI1_EXTD_DAT7 = 0x00000000uL;

    /* Connections:
     *    DAI1_PB01_O - SRC14_DAT_TDM_OP_I
     *    DAI1_PB01_O - SRC13_DAT_TDM_OP_I
     *    DAI1_PB01_O - SRC15_DAT_TDM_OP_I
     */
    *pREG_DAI1_DAT8 = 0x00000000uL;
    *pREG_DAI1_EXTD_DAT8 = 0x00000000uL;
    ...
    *pREG_DAI1_EXTD_FS4 = 0x00000000uL;
    ...
    /* Connections:
     *    DAI1_LOW - SRC12_FS_IP_I
     *    DAI1_LOW - SRC13_FS_OP_I
     *    DAI1_LOW - SRC13_FS_IP_I
     *    DAI1_LOW - SRC12_FS_OP_I
     *    DAI1_LOW - SRC14_FS_OP_I
     *    DAI1_LOW - SRC14_FS_IP_I
     */
    *pREG_DAI1_FS5 = 0x3def7bdeuL;
    *pREG_DAI1_EXTD_FS5 = 0x00000000uL;

    /* Connections:
     *    DAI1_LOW - SRC15_FS_IP_I
     *    DAI1_LOW - SRC15_FS_OP_I
     */
    *pREG_DAI1_FS6 = 0x000003deuL;
    *pREG_DAI1_EXTD_FS6 = 0x00000000uL;
    ...
    *pREG_DAI1_EXTD_PIN4 = 0x00000000uL;
    ...
    /* Connections:
     *    SPT5A_CLK_O - DAI1_DUMMY_PB02_I
     *    SPT4A_CLK_O - DAI1_DUMMY_PB01_I
     *    SPT7A_CLK_O - DAI1_DUMMY_PB04_I
     *    SPT6A_CLK_O - DAI1_DUMMY_PB03_I
     */
    *pREG_DAI1_PIN5 = 0x06891120uL;
